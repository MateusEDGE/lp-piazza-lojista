...
Landing page de tráfego pago do Piazza Nicomedes — público lojista.
...
dentro do site, em `nexamalls.com.br/empreendimentos/piazza-nicomedes/lojista`:
...
```
/                    página de hubs (é aqui que o anúncio cai)
